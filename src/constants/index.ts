...
export const INCOME_CATEGORIES: Category[] = [
  ...
  { id: 'other_income', name: 'Otros', icon: 'plus-circle', color: '#8B5CF6', type: 'income' },
];
...
export const EXPENSE_CATEGORIES: Category[] = [
  ...
  { id: 'utilities', name: 'Servicios', icon: 'zap', color: '#3B82F6', type: 'expense' },
  ...
  { id: 'shopping', name: 'Compras', icon: 'shopping-bag', color: '#F97316', type: 'expense' },
  { id: 'other_expense', name: 'Otros', icon: 'more-horizontal', color: '#64748B', type: 'expense' },
];
